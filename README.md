...
| 游戏版本 | 补丁 |
|---|---|
| Early Access **Build 1.13.1**（当前最新） | [Releases](../../releases/latest) 里的 `v2.4-for-1.13.1.zip`（[直链](../../releases/download/v2.4/v2.4-for-1.13.1.zip)），或直接使用仓库中的 [`patch-1.13.1/`](patch-1.13.1/) |
| Build 1.12.1 | `v2.3-for-1.12.1.zip`（[直链](../../releases/download/v2.3/v2.3-for-1.12.1.zip)），或 [`patch-1.12.1/`](patch-1.12.1/) |
