...
| 游戏版本 | 补丁 |
|---|---|
| Early Access **Build 1.11.1**（当前最新） | [Releases](../../releases/latest) 里的 `v2.2-for-1.11.1.zip`（[直链](../../releases/download/v2.2/v2.2-for-1.11.1.zip)），或直接使用仓库中的 [`patch-1.11.1/`](patch-1.11.1/) |
