╔══════════════════════════════════════════════════════════╗
║   Pokemon Gamma Emerald（伽马绿宝石）简体中文补丁 v2.3        ║
║   汉化：花水月 FlowaterMoon                                  ║
║   ★ 花水月FlowaterMoon 汉化 ★  未经授权禁止转载，禁止商用      ║
╚══════════════════════════════════════════════════════════╝

适用版本：Pokemon Gamma Emerald Early Access Build 1.12.1（Windows）
其他版本请等待更新，不保证兼容。
...
【更新记录】
- v2.3（2026-08-19）：适配 Build 1.12.1（旧版本补丁装在 1.12.1 上会因地图资源不匹配导致遇怪/领图鉴时闪退，请务必使用对应版本）；
  安装脚本增加游戏版本校验。
